<div class="station-file-upload-wrap row {{ $is_embedder ? 'snapped-to-textarea' : '' }}">
	...
	<div class="col-sm-2">
		<img width="100px" height="100px" src="/packages/whereyart/station-yart5/img/missing.gif" bucket="{{ $bucket_name }}" class="img-thumbnail station-img-thumbnail {{ $for_file ? 'for-file' : '' }}" id="target-{{ $original_el_name }}" data-target="{{ $original_el_name }}">
	</div>
