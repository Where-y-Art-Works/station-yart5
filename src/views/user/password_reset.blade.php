...
<html lang="en">
  <head>
    ...
    <link href="/packages/whereyart/station-yart5/css/login.css" rel="stylesheet">
    ...
    <script src="/packages/whereyart/station-yart5/js/jquery-1.10.2.min.js"></script>
    <script src="/packages/whereyart/station-yart5/js/login.js"></script>
