...
class StationServiceProvider extends ServiceProvider {
	...
	{
		$this->publishes([__DIR__.'/../../../public/' => base_path('/public/packages/whereyart/station-yart5'), 'public']);
		$this->publishes([__DIR__.'/../../config/' => base_path('/config/packages/whereyart/station-yart5'), 'config']);
